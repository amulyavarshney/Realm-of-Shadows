...
export default function Settings() {
  ...
  const Row = ({ label, value, onToggle, testID }: any) => (
    <View style={styles.row}>
      ...
      <Pressable testID={testID} onPress={() => { haptic('select'); onToggle(); }} style={[styles.toggle, value && styles.toggleOn]}>
      ...
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <Card style={{ marginTop: 18 }}>
            ...
            <Row label="Sound effects" value={settings.soundEnabled} onToggle={() => updateSettings({ soundEnabled: !settings.soundEnabled })} testID="toggle-sound" />
            <View style={styles.sep} />
